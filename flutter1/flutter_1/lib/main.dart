...
>>>>>>> 7419b1fb330f7a8021147224a164cbffd8625128
    return MaterialApp(
...
<<<<<<< HEAD
          ...
          children: <Widget>[
            Center(child: perfil(size: 150.0)),
            ...
            Column(
              children: [
                Text(
                  ...
                  style: TextStyle(
                    fontSize: 16.0,
                    color: const Color.fromARGB(255, 123, 28, 139),
                  ),
                ),
                Text(
...
>>>>>>> 7419b1fb330f7a8021147224a164cbffd8625128
    return Container(
      ...
      child: ClipOval(
<<<<<<< HEAD
        child: Image.asset('assets/foto.png', width: size, height: size),
      ),
    );
  }
}
